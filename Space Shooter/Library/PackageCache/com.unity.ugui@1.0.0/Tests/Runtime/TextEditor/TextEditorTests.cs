...
public class TextEditorTests
{
    ...
    public void MoveRight_SkipsInvalidCodePointIndices(string text, int[] codePointIndices)
    {
        ...
        Assert.AreEqual(text.Length, m_TextEditor.stringCursorIndex, "cursorIndex did not reach end");
        Assert.AreEqual(text.Length, m_TextEditor.stringSelectIndex, "selectIndex did not reach end");

        m_TextEditor.MoveRight();

        Assert.AreEqual(text.Length, m_TextEditor.stringCursorIndex, "cursorIndex at end should not change");
        Assert.AreEqual(text.Length, m_TextEditor.stringSelectIndex, "selectIndex at end should not change");
    }
    ...
    public void SelectLeft_ExpandSelectionToPreviousCodePoint(string text, int[] codePointIndices)
    {
        m_TextEditor.text = text;
        m_TextEditor.UpdateTextHandle();
        m_TextEditor.stringCursorIndex = m_TextEditor.stringSelectIndex = text.Length;
